...
#ifdef MYTYPES_GEDLIB_SHARED
#ifndef SRC_ENV_GED_ENV_MYTYPES_CPP_
extern template class GEDEnv<size_t, int, int>;
#endif /* SRC_ENV_GED_ENV_MYTYPES_CPP_ */
#endif /*MYTYPES_GEDLIB_SHARED */
